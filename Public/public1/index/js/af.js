define(function(require) {var $ = require('$');
...
(function($) {
    ...
    $(document).ready(function() {
        ...
        $(document.body).bind("touchstart", function(e) {
            ...
            if (false && !touch.el.data("ignore-pressed"))
                touch.el.addClass("pressed");
            if (prevEl && false && !prevEl.data("ignore-pressed") && prevEl[0] !== touch.el[0])
            ...
            if(touch.el && false && !touch.el.data("ignore-pressed"))
                touch.el.removeClass("pressed");
            touch = {};
            clearTimeout(longTapTimer);
        });
