...
<body>
    <div class="m-pay-order">
        	...
        	<div id="pro-view-1">
        		<div data-pro="entry" class="m-pay-order-list">
        			<div id="pro-view-2" class="m-pay-order-list-item">
        				<span class="m-pay-order-list-item-name">Apple Watch Sport 38毫米 铝金属表壳 运动表带</span>
        				<span class="m-pay-order-list-item-num">
        					<b class="txt-red">2</b>人次
        				</span>
        			</div>
        		</div>
        		<div class="m-pay-order-total">商品合计：<b class="txt-red">2元</b></div>
        	</div>
        </div>
        ...
        <div data-pro="submit" class="m-pay-order-submit"><button id="pro-view-20" class="w-button w-button-main w-button-l">确认支付</button></div>
    </div>



<div id="pro-view-0" class="m-simpleHeader"><a href="javascript:void(0);" data-pro="back" data-back="true" class="m-simpleHeader-back"><i class="ico ico-back"></i></a><h1>支付订单</h1></div></body></html>